<script>
        ...
        // ======================================
        // CHART DATA (FLC HEALTHY EVOLUTION S.R.L.)
        // ======================================
         const chartData = {
             trendRicaviEbitda: {
                 ...
                 datasets: [
                     {
                         label: "Ricavi (€)",
                         data: [818166, 813109, 1037515], // Valori FLC
                     ...
                     {
                         label: "EBITDA (€)",
                         data: [155297, 20908, 154660], // Valori FLC
             ...
             trendWorkingCapital: {
                labels: ['2022', '2023', '2024'],
                 datasets: [
                    { label: 'DSO', data: [69, 81, 128], borderColor: '#4CAF50', backgroundColor: 'rgba(76, 175, 80, 0.2)', fill: false, tension: 0.1 },
                    { label: 'DIO', data: [0, 0, 0], borderColor: '#FFC107', backgroundColor: 'rgba(255, 193, 7, 0.2)', fill: false, tension: 0.1 },
                    { label: 'DPO', data: [12, 32, 109], borderColor: '#4a69bd', backgroundColor: 'rgba(74, 105, 189, 0.2)', fill: false, tension: 0.1 },
                    { label: 'Ciclo Circolante', data: [57, 49, 19], borderColor: '#F44336', backgroundColor: 'rgba(244, 67, 54, 0.2)', fill: true, tension: 0.1, borderWidth: 2 }
                 ]
             },
            trendCashFlowOp: {
                labels: ['2022', '2023', '2024'],
         ...
         const trendRicEbitdaOptionsCda = {
             ...
             scales: {
                 ...
                 y1: { // Asse secondario (destra) per Percentuale
                     ...
                     suggestedMin: 0,
                     suggestedMax: 20, // Adattato per FLC
                     ticks: {
         ...
         const trendPfnEbitdaOptionsCda = {
             ...
             scales: {
                 y: { // Scala per il rapporto
                     ...
                     suggestedMin: -3,
                     suggestedMax: 1.5, // Adattato per FLC
        ...
        const trendWorkingCapitalOptionsCda = {
             ...
             scales: {
                 y: {
                     ...
                     suggestedMax: 140 // Adattato per FLC
                 },
                  x: { grid: { display: false } }
             },
             plugins: {
        ...
        document.addEventListener('DOMContentLoaded', function() {
             console.log("Initializing CDA charts for FLC HEALTHY EVOLUTION S.R.L.");
        ...
        // ======================================
         document.addEventListener('DOMContentLoaded', function() {
             ...
             const irpScoreValue = 87.25; // Valore IRP FLC
